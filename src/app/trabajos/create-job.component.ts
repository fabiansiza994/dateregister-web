...
import { ClientPickerComponent } from '../shared/client-picker.component'; // ajusta la ruta
...
export class CreateJobComponent implements OnInit {
    ...
    async loadFormasPago() {
        ...
        } catch { /* opcional: aviso silencioso */ }
        finally { this.mopLoading.set(false); }
    }
